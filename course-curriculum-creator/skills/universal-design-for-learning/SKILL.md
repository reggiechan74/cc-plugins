...
- [ ] Key concepts are presented in at least 2 different forms (verbal, visual, textual, kinesthetic)
- [ ] Complex processes are illustrated with diagrams, flowcharts, or visual organizers
- [ ] Technical terms and acronyms are defined in context and collected in a reference handout
- [ ] Examples are drawn from multiple contexts so diverse participants can connect
- [ ] A handout or digital reference is available so participants are not reliant on memory alone
...
**Checklist per Module:**
- [ ] At least one activity offers learner choice (in topic, format, or approach)
- [ ] Module opens with an explicit real-world connection or participant-generated relevance
- [ ] Activities include a mix of collaborative and individual work modes
- [ ] Low-stakes practice precedes any formally assessed or publicly shared work
- [ ] Progress is made visible through recaps, checklists, or visual trackers
...
**Checklist per Module:**
- [ ] At least 2 response formats are accepted for major activities (e.g., written + verbal, diagram + text)
- [ ] Time guidance is provided for exercises, with a prioritization strategy if time runs short ("complete Part A first; Part B is a stretch goal")
- [ ] Alternatives to standing or movement-based activities are available for participants who need seated options
- [ ] Non-technology fallback options exist for any activity that relies on devices or software
- [ ] Rubrics and evaluation criteria assess content understanding, not format compliance
...
**Step 1: Include an accommodation prompt in enrollment.**
Add a question to the registration form: "Is there anything we can do to support your learning during this workshop? (Examples: large-print materials, captioning, frequent breaks, seating near the front.)" Frame it as a standard question for all registrants, not a special request.

**Step 2: Build flexibility into the design from the start.**
Design materials, activities, and the physical/virtual environment with common accommodations already built in. Digital materials should be screen-reader compatible. Slides should use high-contrast colors and large fonts. Activities should have built-in time buffers. This reduces the number of individual accommodations needed.

**Step 3: Plan for common accommodations without requiring disclosure.**
Many participants will not disclose needs. Design so that the most common accommodations (readable fonts, breaks, multiple formats, flexible timing) are simply part of the standard experience. No one should need to ask for what should already be there.
...
When generating the course outline, apply UDL by checking:
- **Representation variety**: Does each module use at least 2 different content delivery modes? Flag any module that is lecture-only or text-only.
- **Activity type rotation**: Do activity types vary across consecutive modules? Avoid three discussion-based modules in a row or three solo exercises back-to-back.
- **Breaks and transitions**: Are breaks scheduled at least every 45-60 minutes? Is there transition time between modules for cognitive reset?
- **Engagement scaffolding**: Does the outline progress from low-stakes to higher-stakes activities within each day? Are choice points identified?

### During `/generate-lesson-plans`

When generating detailed lesson plans for each module:
- **Apply at least 2 UDL principles per module**: Each lesson plan should explicitly address representation (how content is presented) and at least one of engagement or expression.
- **Materials in digital + physical**: Specify that materials are available in both digital and print formats. Note screen-reader compatibility requirements for digital materials.
- **Facilitation notes for inclusion**: Include instructor guidance such as "read slide content aloud for participants who may not see the screen clearly" and "provide 30 seconds of think time before opening discussion."
- **Multiple response formats**: For each activity, specify at least 2 acceptable ways participants can respond or demonstrate understanding.

### During `/generate-artifacts --type handout`

When generating handouts and participant materials:
- **Readable formatting**: Use 12pt minimum font, sans-serif typeface, 1.15+ line spacing, adequate white space, left-aligned text (not justified).
- **Visual organizers**: Include diagrams, tables, or concept maps that organize information spatially, not just linearly.
- **Structured workspace**: Provide fillable fields, checkboxes, and guided prompts rather than blank space (blank space is overwhelming; structure enables participation).
- **Reference sections**: Include glossaries, key concept summaries, and "what to do if stuck" guidance so participants can self-support.

### During `/generate-rubrics`

When generating assessment rubrics:
- **Assess content, not format**: Rubric criteria should evaluate understanding and application, not presentation polish, grammar, or handwriting quality.
- **Format-neutral criteria**: Use language like "demonstrates understanding of X through explanation, diagram, or example" rather than "writes a paragraph explaining X."
- **"Demonstrates understanding through..." phrasing**: Frame criteria with this stem to signal that multiple expression modes are acceptable. Example: "Demonstrates understanding of the design tradeoffs through a comparison (written, verbal, or visual)."

### During `/review-curriculum`

When reviewing curriculum for quality, add a UDL validation dimension:
- **Representation coverage**: Does each module present key concepts in at least 2 modes? Flag modules with only one representation mode.
- **Engagement choices**: Does each half-day include at least one learner choice point? Flag half-days with zero choice.
- **Expression flexibility**: Does at least one major assessment per day offer format choice? Flag days where all assessments require the same output format.
- **Accommodation readiness**: Are materials available in accessible formats? Are breaks adequate? Is the schedule flexible enough to accommodate common needs without disruption?
...
- [ ] Every module presents key concepts in at least 2 different modes (verbal, visual, textual, kinesthetic)
- [ ] Complex processes are visualized through diagrams, flowcharts, or step-by-step graphics
- [ ] Technical vocabulary is defined in context and compiled in a glossary handout
- [ ] Examples span at least 2-3 different domains or contexts
- [ ] A reference handout or digital resource is available for every module so participants are not reliant on memory

### Engagement (The "Why")
- [ ] Each half-day includes at least one activity with meaningful learner choice
- [ ] Every module opens with an explicit connection to real-world application or participant-generated relevance
- [ ] Activities alternate between collaborative and individual work modes across the day
- [ ] Low-stakes practice precedes any formally assessed or publicly shared performance
- [ ] Progress is made visible through recaps, checklists, or visual tracking within each half-day

### Action & Expression (The "How")
- [ ] At least 2 response formats are accepted for major activities in each module
- [ ] Time guidance and prioritization strategies are provided for every timed exercise
- [ ] Seated alternatives exist for any activity that assumes standing or physical movement
- [ ] Non-technology fallback options are planned for every digital activity
- [ ] Rubrics assess content understanding, not format compliance or presentation polish

### Proactive Accommodation
- [ ] All materials are available in both digital and print formats
- [ ] Font sizes meet minimums: 18pt+ for projected slides, 12pt+ for handouts
- [ ] Color is never the sole carrier of meaning (always paired with labels, patterns, or icons)
- [ ] Breaks are scheduled at least every 45-60 minutes
- [ ] Buffer time (10-15% of schedule) is built into the workshop timeline for overruns and flexibility
- [ ] Core pre-reading materials are sent to participants at least 48 hours before the workshop
